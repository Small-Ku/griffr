...
| [`API_YOSTAR.md`](API_YOSTAR.md) | Reverse-engineered YoStar Arknights KR/EN/JP launcher/game update protocol and comparison with Hypergryph/Gryphline delivery semantics |
