...
| Endfield OS | `POST https://launcher.gryphline.com/api/proxy/batch_proxy` |
...
| `u8` | `u8.gryphline.com` | OS | Account-to-game-server token exchange & server list (OS only) |
...
| Component | Arknights CN | Endfield CN | Endfield OS | Endfield OS Epic |
|-----------|--------------|-------------|-------------|------------------|
...
| `beyond.hg-cdn.com` | Endfield OS | No |
...
| Global Official | `6` | `6` | `YDUTE5gscDZ229CW` |
| Global Epic | `6` | `801` | `YDUTE5gscDZ229CW` |
