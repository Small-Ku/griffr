...
async fn test_execute_reuse_plan_multiple_source_channels() {
    ...
    let plan = ReusePlan {
        source_channels: vec![
            ...
            SourceChannel {
                channel_id: ChannelPair::from_api("2", None::<String>).unwrap(),
                version: "1.0.0".to_string(),
        ...
        reusable_files: vec![
            ...
            ReusableFile {
                ...
                md5: "hash2".to_string(),
                size: 13,
                source_channel_id: ChannelPair::from_api("2", None::<String>).unwrap(),
...
fn test_reusable_file_struct() {
    let file = ReusableFile {
        ...
        size: 2048,
        source_channel_id: ChannelPair::from_api("6", None::<String>).unwrap(),
