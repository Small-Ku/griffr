...
use griffr_hypergryph_api::{ResourcePatch, ResourcePatchEntry};
...
mod tests {
    use super::*;
    use crate::patch_apply::write_patch_plan;
    use crate::{PatchPlan, PlannedPatchEntry, PlannedPatchSource};
    ...
    fn discard_incomplete_patch_apply_removes_only_private_state() {
        ...
        let predownload = crate::griffr_predownload_path(&install_root).join("1.0-1.1");
