...
use crate::{ArtifactProof, PATCH_MANIFEST_NAME, PATCH_STAGE_DIR};

use griffr_hypergryph_api::ResourcePatch;
...
mod tests {
    ...
    use crate::{PATCH_MANIFEST_NAME, PATCH_STAGE_DIR};
  ...
  "files": [
    {
      ...
      "patch": []
        ...
        assert_eq!(proofs[0].source(), crate::ArtifactSource::LocalPatch);
        assert_eq!(
            progress,
            vec![
                ("".to_string(), 0, 1),
