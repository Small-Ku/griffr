...
use crate::progress::RunningByteProgress;
use crate::{ProgressUnit, ProgressUpdate};
...
impl TaskProgressReducer {
    ...
    fn start_download_lane(&mut self, lane: crate::ProgressLane, total: u64) {
    ...
    fn emit_bytes(&self, lane: crate::ProgressLane, finished: u64, total: u64, item: &str) {
    ...
    fn emit_items(
        sender: &crate::ProgressSender,
        lane: crate::ProgressLane,
        item: &str,
        finished: u64,
        total: u64,
        started: &mut bool,
