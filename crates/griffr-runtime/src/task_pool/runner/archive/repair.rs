...
use crate::task_pool::fs_ops::{commit_observed_artifact, create_extract_staging_dir};
use crate::task_pool::graph::TaskRun;
use crate::task_pool::types::{
    ArchiveFileRepairTask, ArchiveRepairSession, ArchiveWork, PreparedArchiveRepairGroup, Task,
    WorkerEvent,
};
use crate::{griffr_archives_path, ArtifactExpectation, ArtifactSource, PatchApplyOptions};
...
pub(crate) fn run_extract_archive_repair_file(
    ...
    if let Ok(part_path) = crate::task_pool::fs_ops::make_partial_download_path(&repair.dest) {
...
mod tests {
    ...
    use crate::griffr_archives_path;
    use crate::task_pool::types::{
