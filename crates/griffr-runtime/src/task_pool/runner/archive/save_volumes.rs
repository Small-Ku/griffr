...
use crate::preallocate_file;
use crate::task_pool::blocking_buffer::with_blocking_io_buffer;
use crate::task_pool::fs_ops::commit_partial_download;
use crate::task_pool::graph::{GraphExpansion, TaskRun};
use crate::task_pool::types::{ArchivePart, ArchiveRangePriority, ArchiveWork, Task, WorkerEvent};
use crate::task_pool::verify;
...
mod tests {
    ...
    use crate::task_pool::types::ArchiveRetention;
    use crate::PatchApplyOptions;
    ...
    fn cached_ranges_are_saved_as_independent_verified_archive_volumes() {
        ...
        let parts = vec![
            ArchivePart {
                ...
                expected_md5: griffr_core::to_hex(&Md5::digest(first_bytes)),
            ...
            ArchivePart {
                ...
                expected_md5: griffr_core::to_hex(&Md5::digest(second_bytes)),
