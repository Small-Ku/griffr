...
use crate::task_pool::fs_ops::{commit_partial_download, make_partial_download_path};
...
fn archive_identity(parts: &[ArchivePart]) -> String {
    ...
    griffr_core::to_hex(&identity.finalize())
}
...
mod tests {
    ...
    fn ready_volume_partial_is_promoted_before_range_planning() {
        ...
        let part = ArchivePart {
            ...
            expected_md5: griffr_core::to_hex(&Md5::digest(bytes)),
