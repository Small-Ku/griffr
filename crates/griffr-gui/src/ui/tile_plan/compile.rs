...
use crate::ui::{
    ClipPolicy, CompiledPlan, LayoutDirection, LayoutSpec, SizingPolicy, StaticPlan, TileId, TilePlan, TileSpec,
    ...
    let mut widgets: Vec<WidgetNode> = decls
        ...
        .map(|d| WidgetNode {
            ...
            layout: LayoutSpec {
                ...
                margin: d.margin,
                padding: d.padding,
                sizing: match d.sizing_mode {
                    1 => SizingPolicy::AspectRatio(d.sizing_f1),
                    2 => SizingPolicy::Fixed(Size::new(d.sizing_f1, d.sizing_f2)),
                    _ => SizingPolicy::Flex { grow: d.sizing_f1, shrink: d.sizing_f2, basis: d.sizing_f3 },
                },
            },
            z_order: d.z,
