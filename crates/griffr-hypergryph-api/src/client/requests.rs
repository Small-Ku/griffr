...
use crate::{
    protocol::{
        batch_proxy_url, latest_game_batch, latest_resources_url, media_batch, web_batch_proxy_url,
        CONTENT_TYPE_HEADER, JSON_CONTENT_TYPE, MIN_USER_AGENT as PROTOCOL_MIN_USER_AGENT,
        OFFICIAL_USER_AGENT as PROTOCOL_OFFICIAL_USER_AGENT, USER_AGENT_HEADER,
    },
    ApiTarget, BatchRequest, BatchResponse, Error, GetLatestGameResponse,
    GetLatestResourcesResponse, ProxyResponse, Result,
};
...
impl ApiClient {
    ...
    /// User-Agent used for launcher API and related CDN requests.
